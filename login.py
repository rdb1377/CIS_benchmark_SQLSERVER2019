...
class Login:
    ...
    def loginControlFrame(self):
        ...
        self.login_frame_title = tk.Label(self.loginFrame, text="Login Here", font=("Impact", 35), bg="white",fg="#5856a0")
        self.login_frame_title.grid(row=0, columnspan=2, padx=10, pady=20, sticky="w")


        # Username
        self.username_label = tk.Label(self.loginFrame, text="Username", font=("Times New Roman", 16, "bold"), bg="white", fg="#5856a0")
        ...
        # Password
        self.password_label = tk.Label(self.loginFrame, text="Password", font=("Times New Roman", 16, "bold"), bg="white", fg="#5856a0")
        ...
        #server
        self.server_label = tk.Label(self.loginFrame, text="Server Name:" ,font=("Times New Roman", 16, "bold"), bg="white", fg="#5856a0")
        ...
        #auth
        self.auth_label = tk.Label(self.loginFrame, text="Authentication:" ,font=("Times New Roman", 16, "bold"), bg="white", fg="#5856a0")
        ...
        self.driver_label = tk.Label(self.loginFrame, text="Driver:", font=("Times New Roman", 16, "bold"), bg="white", fg="#5856a0")
        ...
        # Login Button
        self.connect_btn = tk.Button(self.loginFrame, command=lambda: self.connect(), text="Login", bd=0, cursor="hand2", fg="white", bg="#5856a0", width=10, font=("Impact", 15) , )
        self.connect_btn['state'] = 'disable'
        self.connect_btn.grid(row=6, column=1, padx=10, sticky="e")

        # empty label for spacing in grid
        self.emptyLabel = tk.Label(self.loginFrame, font=("Times New Roman", 16, "bold"), bg="white",fg="#5856a0")
        self.emptyLabel.grid(row=7, column=1, padx=10, pady=5, sticky="w")

        # Right Side Frame as Welcome Message
        self.rightFrame = tk.Frame(self.root, bg="#5856a0")
        self.rightFrame.pack(side=tk.RIGHT)

        self.labelCompanyName = tk.Label(self.rightFrame, text="", font=("Goudy Old Style", 55),bg="#5856a0", fg="white")
        self.labelCompanyName.grid(row=0, column=2, columnspan=2, padx=10)
        self.labelDesc = tk.Label(self.rightFrame, text="", font=("Times New Roman", 25, "italic"), bg="#5856a0", fg="white")
