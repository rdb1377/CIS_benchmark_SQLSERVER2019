...
class Login:
    ...
    def loginControlFrame(self):
        ...
        self.login_frame_title = tk.Label(self.loginFrame, text="CIS Hardening Tool", font=("Impact", 35))
    ...
    def detect_driver(self):
        ...
        if driver_name:
            ...
            messagebox.showerror('error','(No suitable driver found. Cannot connect. please install driver 17 or 18.)')
